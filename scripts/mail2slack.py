...
vendors.add(Vendor('Ślimak', ['Ślimak', 'ślimak', 'slimak'], 'Pan Ślimak'))
vendors.add(Vendor('Jesz to', ['jeż', 'jez'], 'Jesz to'))
vendors.add(Vendor('Borówka', ['borówka', 'borowka'], 'Pan Borówka'))
vendors.add(Vendor('Pajda', ['pajda'], 'Pajda'))
vendors.add(Vendor('Rajskie Smaki', ['rajskie', 'rajskich'], 'Rajskie Smaki'))
vendors.add(Vendor('Green2go', ['green2go', 'green2goo'], 'Grin tu goł'))
vendors.add(Vendor('Pobudka', ['pobudka', 'pobudki'], 'Pan Pobudka'))
